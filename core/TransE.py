...
class TransE(ModelMeta):
    ...
    def infer_tails(self,h,r, topk ):
        ...
        head_vec = tf.nn.embedding_lookup(params=norm_ent_embeddings, ids=h)
        rel_vec = tf.nn.embedding_lookup(params=norm_rel_embeddings, ids=r)
    ...
    def infer_heads(self,r,t, topk ):
        ...
        tail_vec = tf.nn.embedding_lookup(params=norm_ent_embeddings, ids=t)
        rel_vec = tf.nn.embedding_lookup(params=norm_rel_embeddings, ids=r)
